-- Reference copy of the current schema. The source of truth for what actually
-- gets applied is the numbered files in src/lib/db/migrations/ — this file is
-- just a single readable snapshot of what they add up to. Keep it in sync
-- whenever a new migration changes the shape of a table.
